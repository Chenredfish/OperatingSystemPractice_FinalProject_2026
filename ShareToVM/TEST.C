...
/* Che-Wei: Comment out the orginal layout and use my layout *******************************************/
...
/*                      01234567890123456789012345678901234567890123456789012345678901234567890123456789 */
    ...
    PC_DispStr( 0,  1, "                                  Che-Wei Chang                                 ", DISP_FGND_BLACK + DISP_BGND_LIGHT_GRAY);
    PC_DispStr( 0,  2, "                                                                                ", DISP_FGND_BLACK + DISP_BGND_LIGHT_GRAY);
...
/*******************************************************************************************************/
/* Che-Wei: Test the result at Stage 1 *****************************************************************/
/*******************************************************************************************************/
...
/* Che-Wei: Do not need the orginal tasks anymore. Create my own periodic tasks ************************/
